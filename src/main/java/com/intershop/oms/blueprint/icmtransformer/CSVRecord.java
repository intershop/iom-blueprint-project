...
public class CSVRecord<T extends Enum<T> & CSVTable>
{
    ...
    /**
     * This constructor will create an instance of this class with initialized
     * column names and default values for the selected CSVTable enumeration.
     *
     * @param clazz
     */
    ...
    /**
     * Sets the value of the specified column unless the provided value is null
     * or empty.
     *
     * @param header
