 ...
 */
@Stateless
public class ValidateCustomOrderPropertiesSyncrPTBean implements ValidateOrderPT
{
    private Logger log = LoggerFactory.getLogger(ValidateCustomOrderPropertiesSyncrPTBean.class);

    private static final String GROUP   = "order";
    private static final String KEY     = "validation";
    private static final String VALUE   = "fail-syncrounously";
